module github.com/armeldemarsac92/openstack-teleport-reconciler/teleport-helper

go 1.25.11

require github.com/gravitational/teleport/api v0.0.0-20260608121040-679d6278399d
